/**
 * API-037 / API-039 payload (`PerformanceDto`, TS §13; APIS §10.9 — the
 * membership route returns "the same shape as `/me/performance`", so the
 * two endpoints share ONE definition rather than two that could drift).
 *
