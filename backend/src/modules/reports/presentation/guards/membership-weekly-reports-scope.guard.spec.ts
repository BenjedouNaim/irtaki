...
import { MembershipWeeklyReportsScopeGuard } from './membership-weekly-reports-scope.guard';

describe('MembershipWeeklyReportsScopeGuard (API-036, TS §15.2, same semantics as API-032)', () => {
  let guard: MembershipWeeklyReportsScopeGuard;
  ...
  beforeEach(() => {
    ...
    guard = new MembershipWeeklyReportsScopeGuard(scope);
  });
